...
<head>
    ...
    <title>Confirmación de Compra Adicional - EcoVolt Premium</title>
    <style>
...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            <h1><i class="fas fa-plus-circle"></i> ¡Compra Adicional Exitosa!</h1>
            <p>EcoVolt Pro Premium - Dispositivo Adicional</p>
            <p style="font-size: 1rem; margin-top: 0.5rem;">Agregado a tu cuenta premium existente</p>
        </div>
        ...
        <div class="email-content">
            ...
            <p>¡Excelente! Has agregado exitosamente un dispositivo adicional a tu cuenta premium. Tu nuevo medidor se ha integrado perfectamente con tu sistema existente.</p>

            <!-- Mensaje de Éxito -->
            <div class="success-message">
                <h2><i class="fas fa-check-circle"></i> ¡Dispositivo Agregado!</h2>
                <p>Tu compra adicional está siendo procesada</p>
            </div>

            <!-- Detalles del Producto -->
            <div class="info-section">
                <h3><i class="fas fa-plus-circle"></i>Dispositivo Adicional</h3>
                <p><strong>Producto:</strong> EcoVolt Pro Premium (Adicional)</p>
                <p><strong>Precio:</strong> $150 USD</p>
                <p><strong>Soporte Premium:</strong> Ya incluido en tu cuenta</p>
                <p><strong>Garantía:</strong> 2 años premium</p>
                <p><strong>Estado:</strong> <span style="color: var(--green-success); font-weight: 700;">Agregado a tu cuenta</span></p>
            </div>
            ...
            <div class="support-section">
                <h3><i class="fas fa-crown"></i>Tu Soporte Premium Sigue Activo</h3>
                <p>¡Tu soporte premium ya estaba incluido!</p>
                <p>El nuevo dispositivo se beneficia de todos tus servicios premium:</p>
                ...
                <p style="margin-top: 1rem; font-size: 0.9rem;">
                    ...
                    Tu soporte premium se renueva mensualmente
                </p>
            </div>
            ...
            <div class="info-section">
                ...
                <ul class="feature-list">
                    <li><i class="fas fa-truck"></i> Tu dispositivo adicional será enviado a la dirección registrada</li>
                    <li><i class="fas fa-cog"></i> Se configurará automáticamente en tu cuenta</li>
                    <li><i class="fas fa-headset"></i> Tu soporte premium ya está disponible para el nuevo dispositivo</li>
                    <li><i class="fas fa-envelope"></i> Recibirás actualizaciones por email</li>
                </ul>
            </div>

            <p style="margin-top: 2rem; text-align: center;">
                <strong>¡Gracias por expandir tu sistema EcoVolt Pro Premium!</strong><br>
                Estamos emocionados de ayudarte a monitorear más espacios.
            </p>
        </div>
        ...
        <div class="email-footer">
            ...
            <p>Si tienes alguna pregunta sobre tu compra adicional o necesitas asistencia técnica,</p>
