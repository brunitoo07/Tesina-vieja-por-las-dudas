...
<head>
    ...
    <title>Pago - Dispositivo Adicional - EcoVolt</title>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="premium-card">
                    ...
                    <p class="device-description">Dispositivo adicional de monitoreo de energía para tu cuenta premium.</p>
                    ...
                    <div style="background: var(--gradient-gold); color: var(--black-primary); padding: 15px; border-radius: 10px; margin-bottom: 20px; text-align: center;">
                        ...
                        <p style="margin: 5px 0 0 0; font-weight: 600;">Se agregará a tu cuenta existente</p>
                    </div>
                    
                    <ul class="feature-list">
                        <li><i class="fas fa-check-circle"></i> Se agregará a tu cuenta premium</li>
                        <li><i class="fas fa-check-circle"></i> Mismo soporte 24/7 incluido</li>
                        ...
                        <li><i class="fas fa-check-circle"></i> <strong>Mismo soporte premium 24/7</strong></li>
            ...
            <div class="col-md-6">
                <div class="premium-card">
                    ...
                    <!-- Información del Usuario -->
                    <div class="user-info">
                        <h5><i class="fas fa-user me-2"></i>Tu Cuenta Premium</h5>
                        <p><strong>Nombre:</strong> <?= esc($usuario['nombre']) ?> <?= esc($usuario['apellido']) ?></p>
                        <p><strong>Email:</strong> <?= esc($usuario['email']) ?></p>
                        <p><strong>Tipo:</strong> <span style="color: var(--gold-primary); font-weight: 700;">Compra Adicional</span></p>
                    </div>
                    ...
                    <div class="mb-3" style="display: flex; justify-content: space-between; align-items: center; padding: 0.5rem 0; border-bottom: 1px solid var(--black-light);">
                        <span style="color: var(--silver-primary); font-size: 1.1rem;">Dispositivo Adicional:</span>
                        <span style="color: var(--white-primary); font-weight: 600; font-size: 1.1rem;">$150 USD</span>
                    </div>
                    <div class="mb-3" style="display: flex; justify-content: space-between; align-items: center; padding: 0.5rem 0; border-bottom: 1px solid var(--black-light);">
                        <span style="color: var(--silver-primary); font-size: 1.1rem;">Soporte Premium:</span>
                        <span style="color: var(--gold-primary); font-weight: 600; font-size: 1.1rem;">Ya incluido</span>
                    </div>
                    <div class="mb-3" style="display: flex; justify-content: space-between; align-items: center; padding: 0.5rem 0; border-bottom: 1px solid var(--black-light);">
                    ...
                    <div style="background: var(--gradient-gold); color: var(--black-primary); padding: 10px; border-radius: 8px; margin: 15px 0; text-align: center;">
                        <p style="margin: 0; font-weight: 600; font-size: 0.9rem;">
                            <i class="fas fa-info-circle me-1"></i>Se agregará a tu cuenta existente
                        </p>
                    </div>
                    <hr style="border-color: var(--gold-primary); margin: 2rem 0;">
        ...
        paypal.Buttons({
            ...
            createOrder: function(data, actions) {
                return actions.order.create({
                    purchase_units: [{
                        description: "EcoVolt Pro Premium - Dispositivo Adicional",
                        amount: {
                            currency_code: "USD",
                            value: '150.00',
                            breakdown: {
                        ...
                        items: [{
                            name: "EcoVolt Pro Premium Adicional",
                            description: "Dispositivo adicional para cuenta premium existente",
                            unit_amount: {
                                currency_code: "USD",
                                value: '150.00'
                            },
            ...
            onApprove: function(data, actions) {
                return actions.order.capture().then(function(details) {
                    ...
                    fetch('<?= base_url('compra-existente/procesarPago') ?>', {
                        method: 'POST',
                        headers: {
                        ...
                        if (data.success) {
                            document.getElementById("status").innerHTML = `
                                <div class="alert alert-success" role="alert">
                                    ...
                                    <p>¡Gracias por tu compra adicional, ${details.payer.name.given_name} ${details.payer.name.surname}!</p>
                                    <hr>
