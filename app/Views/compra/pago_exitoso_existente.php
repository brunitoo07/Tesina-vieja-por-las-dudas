...
<head>
    ...
    <title>¡Pago Exitoso! - Dispositivo Adicional - EcoVolt Premium</title>
...
<body>
    ...
    <div class="success-header">
        <div class="container">
            ...
            <p>Dispositivo Adicional Agregado a tu Cuenta Premium</p>
        </div>
    </div>
            ...
            <div class="col-md-10 col-lg-8">
                ...
                <div class="premium-card text-center">
                    ...
                    <p class="lead" style="font-size: 1.3rem; color: var(--silver-primary);">
                        Tu dispositivo adicional ha sido agregado exitosamente a tu cuenta premium.
                    </p>
                </div>
                ...
                <div class="premium-card">
                    ...
                    <div class="order-info">
                        <h5><i class="fas fa-plus-circle me-2"></i>Dispositivo Adicional</h5>
                ...
                <div class="support-section">
                    <h4><i class="fas fa-crown me-2"></i>Tu Soporte Premium Sigue Activo</h4>
                ...
                <div class="text-center">
                    <a href="<?= base_url('admin/dashboard') ?>" class="btn-premium me-3">
                        <i class="fas fa-tachometer-alt me-2"></i>Ir al Dashboard Admin
                    </a>
                    <a href="<?= base_url('admin/dispositivos') ?>" class="btn-premium">
                        <i class="fas fa-chart-line me-2"></i>Ver Energía Admin
                    </a>
                </div>
            </div>
        </div>
