...
<head>
    ...
    <title>Comprar Medidor Adicional - EcoVolt</title>
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <div class="header">
                <h1>Comprar Medidor Adicional</h1>
                <p class="lead">Completa los datos de envío para tu nuevo medidor</p>
            </div>
            ...
            <div class="content">
                ...
                <form action="<?= base_url('comprar-medidor/procesar') ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="calle" name="calle" 
                               value="<?= $direccion ? $direccion['calle'] : '' ?>" required>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="numero" name="numero" 
                                   value="<?= $direccion ? $direccion['numero'] : '' ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="ciudad" class="form-label">Ciudad</label>
                            <input type="text" class="form-control" id="ciudad" name="ciudad" 
                                   value="<?= $direccion ? $direccion['ciudad'] : '' ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mt-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="codigo_postal" name="codigo_postal" 
                                   value="<?= $direccion ? $direccion['codigo_postal'] : '' ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="pais" class="form-label">País</label>
                            <input type="text" class="form-control" id="pais" name="pais" 
                                   value="<?= $direccion ? $direccion['pais'] : '' ?>" required>
                        </div>
                    </div>

                    <div class="d-grid gap-3 mt-4">
                        <button type="submit" class="btn btn-primary btn-lg">Continuar con el Pago</button>
                        <a href="<?= base_url('dashboard') ?>" class="btn btn-outline-light btn-lg">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
