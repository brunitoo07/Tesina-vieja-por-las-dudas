...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-04-2025 a las 14:56:30
...
INSERT INTO `invitaciones` (`id_invitacion`, `email`, `id_rol`, `token`, `estado`, `fecha_expiracion`, `id_usuario`, `created_at`) VALUES
(1, 'enzoguerreiro76@gmail.com', 1, 'EBKlLcVNefKJxP2bjNzCsIVdrswwYggm', 'pendiente', '2025-04-11 09:28:14', 1, '2025-04-10 09:28:14'),
(2, 'balexc777@gmail.com', 1, 'd45XdfnizB8lrTznM2EGR8zGbezNCqS7', 'pendiente', '2025-04-11 09:43:36', 1, '2025-04-10 09:43:36');
...
INSERT INTO `usuario` (`id_usuario`, `nombre`, `apellido`, `email`, `contrasena`, `direccion_id`, `id_rol`, `created_at`, `updated_at`) VALUES
(1, 'brunito', 'barber', 'brunocameille@alumnos.itr3.edu.ar', '$2y$10$F4xQfULyrVhG1JD8Y21QR.vgn9Fzd257acxjmQqHQ3OYfEqBaAPb6', 0, 1, '2025-04-07 16:37:30', '2025-04-07 23:16:03'),
(2, 'Enzito', 'Guerreiro', 'enzito@gmail.com', '$2y$10$jzwxYVyrdKct.o/37a.m0eeN.rK3Z.1f0oDqD0VgRTIfsSO6Kyccy', 0, 2, '2025-04-07 16:37:30', '2025-04-07 16:37:30'),
(3, 'mateo', 'cameille', 'mateito@gmail.com', '$2y$10$E3dKXizu.mLU5j0cUk/Iw.I.j1SsGZidsYiHGXZmvT/YHFf6FrQ0C', 0, 2, '2025-04-07 16:37:30', '2025-04-07 16:37:30'),
(4, 'Enzo', 'Guerreiro', 'enzoguerreiro76@gmail.com', '$2y$10$7LyF68fAWDiExMusIFa3.ex0H5Kfc4/rUjYLh8T6Udr3B4hy.6IVi', 0, 2, '2025-04-07 16:37:30', '2025-04-07 16:37:30'),
(5, 'ivo', 'Ferrer', 'ivojaja@gmail.com', '$2y$10$CqbMhLsdXSOPn1W3w3ngu.HIyM3puLJaoxIRIw4KSjlRPaZgdnvAu', 0, 2, '2025-04-07 16:37:30', '2025-04-07 17:35:44'),
(6, 'Enzito', 'Guerreiro', 'enzoguerreiro@alumnos.itr3.edu.ar', '$2y$10$6L7CavehkQe/oKqbpaKwMuDB22Krdw4lgWhKwSzHh4TgCt45LHY4u', 0, 2, '2025-04-07 16:37:30', '2025-04-07 17:36:07'),
(7, 'manu', 'urrutia', 'manuel@gmail.com', '$2y$10$imD4jb17C1jcSSPJ.B9tfOlNtt/Dr7QRorjXSQppr3w6Yv0qaNz2u', 0, 2, '2025-04-07 16:37:30', '2025-04-07 17:36:40'),
(8, 'holanda', 'jaja', 'Holanda@gmail.com', '$2y$10$oMLV.8SEaFDrTxquJXZt5eSlje65FJ/.9R9JvViUIhdVDCoSXV4hG', 0, 2, '2025-04-07 16:37:30', '2025-04-07 16:37:30'),
(10, 'enzo', 'guerreiro', 'ennnzo757@gmail.com', '$2y$10$.REx8jQNh91IsVy8ty56h.fjWJ83mqTDYx1eVOHz19DvEACdmv3je', 0, 2, '2025-04-07 16:37:30', '2025-04-07 16:37:30'),
(12, 'coker', 'basile', 'cocobasile@gmail.com', '$2y$10$l8L8/qExxJRt1VnwaifymeD8jNTDFf9a0DDFNvuk3xxbco./vu5Fe', 0, 2, '2025-04-07 16:37:30', '2025-04-07 16:37:30'),
(13, 'dario', 'BERAGALIA', 'dariobergagna@gmail.com', '$2y$10$Xdki8XC1qjdrXhXX/Yd48uQdtBiwiLMeTo5HvQMDxXj7KiR2shDoC', 0, 1, '2025-04-07 16:37:30', '2025-04-08 14:51:19'),
(14, 'cristian ', 'JAJAJAJ', 'cristian@gmail.com', '$2y$10$YPAM8gcoLySBVuxY3zUp7OdT1bwOUpaYAnHPw4cVVMobiw4cQyWwC', 0, 2, '2025-04-07 16:37:30', '2025-04-07 16:37:30'),
(15, 'serfio', 'campo', 'sergio@gmail.com', '$2y$10$AxTvxLy7T2S6hx/n7uT3Ye0i8iCHVyUNlpfIzd9Z7muNmyzt.S/Nq', 0, 2, '2025-04-07 16:37:30', '2025-04-07 16:37:30'),
(16, 'jose', 'luis', 'josesinnn@gmail.com', '$2y$10$anBDz9Q87s3O9hEFFwCE/OmFcnCDczNXl4DXKrdHZxmf/vCCdKiwC', 0, 2, '2025-04-07 16:37:30', '2025-04-07 16:37:30'),
(17, 'yayin', 'cameille', 'yayin@gmail.com', '$2y$10$OAzh7jiRiYF/XRZQatD68O6P30e28OWqMPJumIa8W2WOk/8C39ipO', 0, 1, '2025-04-07 16:37:30', '2025-04-07 16:37:30'),
(20, 'sasha', 'ferro', 'sasha@gmail.com', '$2y$10$fjJnPro4sAhNdAdVCMRppum3dL/uFApMBvKrSO5vpSL7/MQwKhDGi', 0, 1, '2025-04-07 18:01:22', '2025-04-08 14:51:28'),
(22, 'ennzo', 'fernandez', 'enzof@gmail.com', '$2y$10$7Jefk2Lft0.raSv9aMh6b.nm0.htn5tOXNWtW/JjwrvDyA/hcjeJa', 0, 1, '2025-04-08 14:09:37', '2025-04-08 14:09:37');
